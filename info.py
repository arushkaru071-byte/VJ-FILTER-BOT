...
PICS = (environ.get('PICS', 'https://i.ibb.co/TBfWBFyK/IMG-20250616-WA0014.jpg')).split()
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://i.ibb.co/TBfWBFyK/IMG-20250616-WA0014.jpg') # payment code picture url.
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://testofphoenixfilter-1fa60b1b8498.herokuapp.com/")
